! function(e) { var t = {};
    ...
    i.m = e, i.c = t, i.d = function(e, t, n) { i.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: n }) }, i.r = function(e) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }) }, i.t = function(e, t) { if (1 & t && (e = i(e)), 8 & t) return e; if (4 & t && "object" == typeof e && e && e.__esModule) return e; var n = Object.create(null); if (i.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e)
            for (var o in e) i.d(n, o, function(t) { return e[t] }.bind(null, o)); return n }, i.n = function(e) { var t = e && e.__esModule ? function() { return e.default } : function() { return e }; return i.d(t, "a", t), t }, i.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, i.p = "", i(i.s = 15) }({ 0: function(e, t, i) { "use strict";
        ...
        o.VantaBase = class { constructor(e = {}) { var t, i, r, a; if (o.current = this, this.onMouseMoveWrapper = this.onMouseMoveWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(n.c)({}, this.defaultOptions), e instanceof HTMLElement || "string" == typeof e ? Object(n.c)(this.options, { el: e }) : Object(n.c)(this.options, e), this.el = this.options.el, null == this.el) s('Instance needs "el" param!');
            ...
            onMouseMoveWrapper(e) { var t, i, n;
                t = this.renderer.domElement.getBoundingClientRect(), i = this.mouseX = e.clientX - t.left, n = this.mouseY = e.clientY - t.top, i >= 0 && n >= 0 && !this.options.mouseEase && this.triggerMouseMove(i, n) }
            triggerMouseMove(e, t) { this.uniforms && (this.uniforms.u_mouse.value.x = e / this.scale, this.uniforms.u_mouse.value.y = t / this.scale); const i = e / this.width,
        ...
        i.d(t, "b", function() { return s }); var n = i(1),
            o = i(0);
        i.d(t, "a", function() { return n.a }), "object" == typeof THREE && (THREE.Color.prototype.toVector = function() { return new THREE.Vector3(this.r, this.g, this.b) });
        class s extends n.b { constructor(e) { super(e), this.mode = "shader", this.updateUniforms = this.updateUniforms.bind(this) }
            initBasicShader(e = this.fragmentShader, t = this.vertexShader) { var i, n, o; return t || (t = "uniform float u_time;\nuniform vec2 u_resolution;\nvoid main() {\n  gl_Position = vec4( position, 1.0 );\n}"), this.updateUniforms(), "function" == typeof this.valuesChanger && this.valuesChanger(), i = new THREE.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }), (o = this.options.texturePath) && (this.uniforms.u_tex = { type: "t", value: (new THREE.TextureLoader).load(o) }), n = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), i), this.scene.add(n), this.camera = new THREE.Camera, this.camera.position.z = 1 }
            updateUniforms() { var e, t, i, n; for (e in t = {}, i = this.options) n = i[e], -1 !== e.toLowerCase().indexOf("color") ? t[e] = { type: "v3", value: new THREE.Color(n).toVector() } : "number" == typeof n && (t[e] = { type: "f", value: n }); return Object(o.c)(this.uniforms, t) }
            init() { super.init(), this.fragmentShader && this.initBasicShader() }
            resize() { super.resize(), this.uniforms.u_resolution.value.x = this.width / this.scale, this.uniforms.u_resolution.value.y = this.height / this.scale } } } });